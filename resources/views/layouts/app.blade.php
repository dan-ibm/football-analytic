            ...
            <div class="container">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="/events#football">Football</a>
                        <a class="dropdown-item" href="/events#hockey">Hockey</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="/events#cyber">Cybersport</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
